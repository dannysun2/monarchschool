...
SQLString="SELECT *,DATE_FORMAT(date_taken,'%m/%d/%Y') AS dt_taken FROM grades WHERE grades_id="+cstr(gid)
...
%>
			<div class="block2">
				...
				<div class="block_content">
					...
					<div class="message warning"><p>Are you sure you want to delete the test taken on <u><% =dt_taken %></u> by <u><% =name %></u>? Deleting grades will result in a permanent loss.</p></div>
					<p>
