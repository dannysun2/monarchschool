...
sql_string="Select *,DATE_FORMAT(dob_date,'%m/%d/%Y') AS dobDate,DATE_FORMAT(ed_date,'%m/%d/%Y') AS edDate from student WHERE student_id=" +bidvalue
...
Set rs = Server.CreateObject("ADODB.Recordset")
sql_string="Select *,DATE_FORMAT(date_taken,'%m/%d/%Y') AS dtDate from grades WHERE student_id=" +bidvalue + " order by date_taken desc, grades_id desc"
rs.open sql_string, "DSN=gl1181;UID=gl1181;PWD=YVT52ddnJ;"

'GRADES COUNT'
Set rs2 = Server.CreateObject("ADODB.Recordset")
sql_string2="Select *,DATE_FORMAT(date_taken,'%m/%d/%Y') AS dtDate from grades WHERE student_id=" +bidvalue + " order by date_taken desc, grades_id desc"
