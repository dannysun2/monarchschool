				...
				<div class="block_content">
					<form name="addstudent" action="student.asp" method="post">
						...
						<p>
							...
							<input type="text" placeholder="MM/DD/YYYY" class="text date_picker" id="stu_dob" name="stu_dob" value="<% =dob %>"/>
							<font color='red'> <% =dob_error %> </font>
						</p>
						<p>		
							<label>Enrollment Date:</label> 
							<input type="text" placeholder="MM/DD/YYYY" class="text date_picker" id="enrolldate" name="enrolldate" value="<% if ed = "" then %><% =date() %><% else %><% =cstr(ed) %><% end if %>"/>
