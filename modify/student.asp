...
SQLString="SELECT *,CONVERT(varchar(10),dob_date,101) as dobdate,CONVERT(varchar(10),ed_date,101) as eddate FROM student WHERE student_id="+cstr(sid)
...
dob = convertDate(request.form("stu_dob"))

ed = convertDate(request.form("enrolldate"))

SQLString="UPDATE student SET "
SQLString=SQLString+ " stu_fname = "+ chr(39) + request.form("f_name")  + chr(39)   
SQLString=SQLString+ ", stu_lname = "+ chr(39) + request.form("l_name")  + chr(39) 
SQLString=SQLString+ ", stu_mname = "+ chr(39) + request.form("m_name")  + chr(39)
